...
var A = /*#__PURE__*/function (_Component) {
  ...
  function A() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onDown", function (e) {
      if (e instanceof TouchEvent) _this.base.haveTouchEvent = true;
      if (_this.base.haveTouchEvent && !(e instanceof TouchEvent)) return; //e.preventDefault();
    ...
    _defineProperty(_assertThisInitialized(_this), "onUp", function (e) {
      if (e instanceof TouchEvent) _this.base.haveTouchEvent = true;
      if (_this.base.haveTouchEvent && !(e instanceof TouchEvent)) return;
