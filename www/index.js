...
var A = /*#__PURE__*/function (_Component) {
  ...
  function A() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onDown", function (e) {
      //e.preventDefault();
      e.stopPropagation();
      if (_this.props.onPress && !_this.base.isPressed) _this.props.onPress();
      if (_this.props.onRelease && !_this.base.isPressed) _this.base.className += " pressed";
    ...
    _defineProperty(_assertThisInitialized(_this), "onUp", function (e) {
      ...
      if (_this.props.onRelease && _this.base.isPressed) {
