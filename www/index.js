...
var SongLayers = /*#__PURE__*/function (_Component) {
  ...
  function SongLayers() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(SongLayers)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "onLayerIconPress", function (index) {
      var el = document.querySelector(".layer-button-" + index);
    ...
    value: function render() {
      ...
      return (0, _preact.h)("div", {
        ...
        return (0, _preact.h)(_A["default"], {
          ...
          "class": "layer-icon",
          onPress: _this2.onLayerIconPress.bind(null, index),
          onRelease: _this2.context.setLayerIndex.bind(null, index)
        }, (0, _preact.h)("img", {
          src: "img/" + _this2.context.getInstrumentByName(layer.instrumentName).icon
        })), (0, _preact.h)(_A["default"], {
          "class": "layer-icon",
          onPress: _this2.context.toggleLayerAudible.bind(null, index)
        }, (0, _preact.h)("img", {
          src: icon
        })));
      }), (0, _preact.h)(_A["default"], {
